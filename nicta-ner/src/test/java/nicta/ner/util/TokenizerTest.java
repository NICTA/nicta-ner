...
public class TokenizerTest {
    ...
    public void testProcess(final String text, final List<List<String>> results) throws Exception {
        final JTokenizer t = new JTokenizer(JTokenizer.TOKENIZER_MODE.WITH_PUNCTUATE);
